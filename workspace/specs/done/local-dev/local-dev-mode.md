...
Linked development skill 'my-skill' from $HOME/projects/my-skill
Agents: claude, cursor, codex
Scope: project

The skill is now available to your agents. Changes to files in
$HOME/projects/my-skill will be immediately visible.
```
...
Linked development skill 'existing-skill' from $HOME/projects/my-skill
...
[project] my-skill
    -> $HOME/projects/my-skill
    Agents: claude, cursor, codex

[global] shared-skill
    -> $HOME/shared-skills/shared-skill
    Agents: claude, cursor
    Overrides: default
```
...
[
  ...
  {
    "name": "shared-skill",
    "path": "$HOME/shared-skills/shared-skill",
    "agents": ["claude", "cursor"],
    "global": true,
    "overrides": "default"
  }
...
--------------------------------------------------
Path: $HOME/projects/my-skill
Absolute: $HOME/projects/my-skill
Global: false
Agents: claude, cursor, codex
SKILL.md exists: true

Linked to:
  claude: $HOME/.claude/skills/my-skill
  cursor: $HOME/.cursor/skills/my-skill
  codex: $HOME/.codex/skills/my-skill
```
