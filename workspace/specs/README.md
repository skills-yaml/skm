...
| [workspace-skill-bundle-install.md](test/workspace-toolkit/workspace-skill-bundle-install.md) | `workspace-toolkit` | `test` | The 0.7.0 development binary passed search, preview, apply, `skm check`, and repeat-add against the published 20-member Registry bundle; production publication remains pending. |
