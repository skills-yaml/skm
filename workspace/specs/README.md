...
| --- | --- | --- | --- |
| [unified-skill-bundle-discovery.md](test/registry/unified-skill-bundle-discovery.md) | `registry` | `test` | PR #46 merged into `development` at `34d516e` after passing Validate; production release remains pending. |
...
| [workspace-skill-bundle-install.md](test/workspace-toolkit/workspace-skill-bundle-install.md) | `workspace-toolkit` | `test` | PR #44 merged the bundle command and PR #47 merged the 0.7.0 candidate into `development`; run `35992853126` published a qualified development prerelease, while Registry publication and production release remain pending. |
