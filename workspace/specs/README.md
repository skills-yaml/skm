...
| [workspace-skill-bundle-install.md](test/workspace-toolkit/workspace-skill-bundle-install.md) | `workspace-toolkit` | `test` | PR #44 merged into `development` at `29ba7dc` after passing Validate; development release and published Registry bundle qualification remain pending. |
