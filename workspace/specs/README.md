...
| [workspace-skill-bundle-install.md](development/workspace-toolkit/workspace-skill-bundle-install.md) | `workspace-toolkit` | `development` | Generic `skm bundle add` passes local gates with schema-2 fixtures; Registry publication, review, and development integration remain pending. |
