...
Use this template for required and conditional files under
...
Tech docs are static by default. Automation may create inventory reports or
generated context blocks, but it must not rewrite project-owned tech docs
