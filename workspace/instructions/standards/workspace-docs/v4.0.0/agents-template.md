...
````md
<!-- AGENT-CONTEXT:START workspace-docs@4.0.0 -->
## Workspace Documentation Standard

This project follows `workspace-docs@4.0.0`.
...
canonical status catalog. Update its spec link, feature, state, and status
rationale in the same change whenever a spec is created, moves state, changes
primary feature, is reopened, or otherwise changes why it is in its state.
...
- **Company Context & Reference (`workspace/company/`)**: Non-code business documentation, brand assets, design systems, domain glossaries (`workspace/company/domain/`), and product strategy briefs (`workspace/company/strategy/`).
