...
This process applies to projects that adopt `workspace-docs@2.0.0`.

## Intake

1. Read the project `AGENTS.md`.
2. Read the relevant required docs under `instructions/tech/`.
3. Check the relevant spec state under `specs/`.
