...
`workspace-docs@1.2.0` requires spec-driven development for non-trivial work.
...
Legacy spec locations such as `specs/` or `.kiro/specs/` may exist during migration, but new workspace-aligned work should use `docs/specs/`.
